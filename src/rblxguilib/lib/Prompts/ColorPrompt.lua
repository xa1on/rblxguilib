...
function ColorPrompt.new(Arguments)
    ...
    util.ColorSync(self.LeftHueIndicator, "ImageColor3", Enum.StudioStyleGuideColor.MainText)
    ...
    util.ColorSync(self.RightHueIndicator, "ImageColor3", Enum.StudioStyleGuideColor.MainText)
    ...
    util.ColorSync(self.ColorPreview, "BorderColor3", Enum.StudioStyleGuideColor.Border)
